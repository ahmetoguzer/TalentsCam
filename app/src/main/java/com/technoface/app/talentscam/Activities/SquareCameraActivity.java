...
/**
 * Created by Ahmet Oguzer on 1.12.2017.
 */
...
public class SquareCameraActivity extends AnncaCameraActivity<Integer> {
    ...
    public void updateCameraPreview(Size size, View cameraPreview) {
        ...
        setCustomCameraPreview(cameraPreview, size, new Size(720,720));
    }
    ...
    public void onVideoRecordStop() {
        ...
        File dir = SquareCameraActivity.this.getExternalCacheDir();

        final File videoFileName = new File(dir, AppController.getInstance().userId + "-" + AppController.getInstance().CompetitonId + "-" +
        ...
        String[] cmd = {"-i", in, "-filter:v","crop=" + 720 + ":" + 720 + ":" + 0 + ":" + height/2,"-threads","5","-preset","ultrafast","-strict","-2" ,"-c:a","copy", videoFileName.getPath()};
        try {
